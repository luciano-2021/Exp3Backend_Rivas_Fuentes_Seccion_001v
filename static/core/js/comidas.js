$(function() {
    ...
    $("#btnCrear").click(function(){
        ...
        $("#fldSubMenu").slideUp();
        $("#dvCreaReceta").fadeIn("slow");
        $("#fldSubMenu").addClass('d-none');
        $("#dvCreaReceta").removeClass('d-none');
    });

   
    $(".btnVolverRecMan").click(function(){
        hidden();
        $("#fldSubMenu").removeClass('d-none');
        $("#fldSubMenu").slideDown("slow");
    });
});
